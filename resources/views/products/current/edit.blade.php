                                ...
                                <div class="input-group input-group-merge input-group-alternative">
                                    <select id="form_product_type" class="form-control" name="type_id">
                                        @foreach($product_types as $type)
                                            <option @if($product->type->id === $type->id) selected @endif class="@if($type->category_id !== 1) d-none @endif" data-category-id="{{$type->category_id}}" value="{{ $type->id }}">{{ $type->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
